...
public class MatchEventService : IMatchEventService
{
        ...
        MatchResult result)
    {
        ...
        var existingResult =
            await _matchResultRepository.GetByMatchIdAsync(matchId);
    ...
    {
        var exists = await _goalRepository.ExistAsync(goalId);
    ...
    {
        var exists = await _cardRepository.ExistAsync(cardId);
