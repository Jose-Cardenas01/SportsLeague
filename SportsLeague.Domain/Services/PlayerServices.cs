...
namespace SportsLeague.Domain.Services
{
    public class PlayerServices : IPlayerServices
    {
        ...
        public PlayerServices(IPlayerRepository playerRepository, ITeamRepository teamRepository, ILogger<PlayerServices> logger)
        {
        ...
        public async Task<IEnumerable<Player>> GetByTeamAsync(int teamId)
        {
            ...
            var teamExists = await _teamRepository.ExistAsync(teamId);
        ...
        {
            // Validar que el equipo existe
            var teamExists = await _teamRepository.ExistAsync(player.TeamId);
        ...
        {
            var exists = await _playerRepository.ExistAsync(id);
